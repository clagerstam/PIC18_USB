...
//!   const char USB_CLASS_SPECIFIC_DESC[] =          ///orig from fernando
//!   {
...
//!   const char USB_CLASS_SPECIFIC_DESC[] =       //ML mod
//!   {
//!      0x05, 0x01, // usage page (generic desktop Choose the usage page "mouse" is on
//!      0x09, 0x02, // usage (mouse) Device is a mouse
//!      0xA1, 0x01, // collection (application) This collection encompasses the report format
...
//!   const char USB_CLASS_SPECIFIC_DESC[] =       //ML created from USB report descriptor application
//!   {
...
//!      0x81, 0x03,       // INPUT (Cnst,Var,Abs)   // ? 0x81, 0x01 ?
//!      0x05, 0x01,       // USAGE_PAGE (Generic Desktop)
//!      0x09, 0x30,       // USAGE (X)
//!      0x09, 0x31,       // USAGE (Y)
//!      //0x09, 0x38,       // USAGE (Wheel)
...
//!   };
   ...
   const char USB_CLASS_SPECIFIC_DESC[] =       //ML created from USB report descriptor application
   {
      ...
      0x15, 0x00,       // LOGICAL_MINIMUM (0)
      0x26, 0x10, 0x27, // LOGICAL_MAXIMUM (10000)
      //0x26, 0x30, 0x75,        // LOGICAL_MAXIMUM (1000)
      0x35, 0x00,       // PHYSICAL_MINIMUM (0)
      0x46, 0x10, 0x27, // PHYSICAL_MAXIMUM (10000)
      //0x46, 0x30, 0x75,       // PHYSICAL_MAXIMUM (1000)
      0x65, 0x00,       // UNIT (None)
      0x75, 0x10,       // REPORT_SIZE (16)
      0x95, 0x02,       // REPORT_COUNT (2)
      0x81, 0x02,       // INPUT (Data,Var,Abs)
